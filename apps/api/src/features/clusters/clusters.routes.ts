...
import { getClusterConfigValidationHandler, getClusterEventsHandler, getClusterLayoutHandler, getClusterOccupancyHandler, listClusters } from "./clusters.controller";
...
clustersRouter.get("/:clusterNumber/events", validateRequest({ params: clusterNumberParamSchema }), getClusterEventsHandler);
