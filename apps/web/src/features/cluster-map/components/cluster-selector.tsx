  ...
  return (
    <div className="flex flex-wrap gap-2">
      {clusters.map((cluster) => {
        const isActive = cluster.number === selectedCluster;
        ...
        return (
          <button
            ...
            className={`min-w-11 rounded-lg px-4 py-2 text-sm font-medium transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-cluster-accent/30 focus-visible:ring-offset-2 focus-visible:outline-none ${
              isActive
