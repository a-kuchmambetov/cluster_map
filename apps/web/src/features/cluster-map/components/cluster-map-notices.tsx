...
export const ClusterMapNotices = ({ map }: ClusterMapNoticesProps) => {
  return (
    <>
      {map.summary.free === 0 && (
        <div className="mt-5 rounded-xl border border-cluster-border bg-cluster-surface-soft px-4 py-3">
        ...
        <div className="mt-5 space-y-2">
          {map.warnings.map((warning) => (
            <div
              ...
              className="rounded-xl border border-cluster-warning/30 bg-cluster-warning-soft px-4 py-3"
              role="status"
            >
