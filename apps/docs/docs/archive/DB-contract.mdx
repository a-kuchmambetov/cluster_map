...
:::note[Historical agreement]

This document preserves earlier design agreements and proposals. It is not the
current implementation contract. See [Domain Model and Data Flow](../architecture/domain-model-and-data-flow) for current behavior.
